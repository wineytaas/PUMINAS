...
public class q5{
   ...
   public static double leLado(char msg){
      ...
      do{
         try{
            ...
            System.out.println("Digite valor postivo maior do que zero!!");
         }
   ...
   public static void valido(double min, double valor) throws Exception{
      if(valor <= min)
         throw new Exception();
   }
   
   public static void intervalo(double min, double max , double valor) throws Exception{
