...
*  um Arranjo de maneira não Recurcivamente
*/
...
public class Q5Array{
   public static void main(String[] args) {
      ...
      escreveArranjo(A);
      System.out.println("Par(es): "+contaPar(A));
      System.out.println("Impar(es): "+contaImpar(A)+"\n");
      
      escreveArranjo(B);
      System.out.println("Par(es): "+contaPar(B));
      System.out.println("Impar(es): "+contaImpar(B)+"\n");
      
      escreveArranjo(C);
      System.out.println("Par(es): "+contaPar(C));
      System.out.println("Impar(es): "+contaImpar(C)+"\n");
   }//fim main
   
   public static int contaPar(int[] x){
      int par = 0;
   ...
   public static int contaImpar(int[] x){
      int impar = 0;
      
      for(int i = 0 ; i < x.length ; i++){
         if(x[i]%2 != 0 && x[i] != 0) impar++;
      }
